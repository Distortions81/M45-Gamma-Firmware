                                                ...
                                                size_t coinbase_len)
{
    ...
    const stratum_payout_result_t result =
        stratum_payout_evaluate(wallet, coinbase, coinbase_len);
    set_pool_payout_status(pool_id, result.status, result.percent_x100);
}
