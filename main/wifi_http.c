...
static esp_err_t status_handler(httpd_req_t *req)
{
    ...
    const wifi_http_status_context_t context = {
        .state = g_state,
        .page_token = g_page_token,
        .ip = g_ip,
        .setup_ssid = g_setup_ssid,
        .setup_ip = g_setup_ip,
        .wifi_connected = g_connected,
        .setup_active = g_setup_ap_active,
        .ota_supported = esp_ota_get_next_update_partition(NULL) != NULL,
        .retained_axeos_count = retained_axeos_count,
        .ota_preserve_axeos_possible =
            retained_axeos_count == 0 || select_ota_update_partition(true) != NULL,
        .axeos_return_available = wifi_http_retained_axeos_available(),
    };
    return wifi_http_status_send(req, &context);
}
